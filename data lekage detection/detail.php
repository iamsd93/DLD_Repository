...
<body class="body">
	...
	<header class="mainHeader">
		...
		<nav><ul>
			...
			<li class="active"><a href="viewfile.html">View Articles</a></li>
...
<form name="frm" id="frm" method="post" action="user/detail1.php?id='.$w1["subject"].'?file='.$w1["fname"].'"> <!-- same-document reference -->
  <table>  
