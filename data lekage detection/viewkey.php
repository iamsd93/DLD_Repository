...
if (!isset($_SESSION['user'])) {
		...
		echo "<script type=\"text/javascript\">"." alert('Please Login'); " ."</script>";
		   ...
		   //   echo  header("Location: http://localhost/Data_leakage NEW/data lekage detaction/userlogin.php");
		//}
...
<body class="body">
	...
	<header class="mainHeader">
		...
		<nav><ul>
			...
			<li><a href="viewfile.php">View Article</a></li>
...
$qry="Select * FROM askkey where user='$_SESSION[user]'";
